...
<head>
  ...
  <link rel="shortcut icon" href="./Assets/logo-brasa-loca-igor-i-go-restaurant.png" type="image/x-icon" />
</head>

<body>
  <header>
    <img src="Assets/logo-brasa-loca-igor-i-go-restaurant.png" alt="Logo del Restaurante" />
  </header>
      ...
      <div class="col-xl-7 col-lg-12 d-flex">
        <div class="container align-self-center p-6">
          ...
          <div class="form-group">
            ...
            <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
              ...
              <div class="form-row mb-3">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="Telefono" class="form-control" placeholder="Tu Telefono" required />
                </div>
              </div>
              <div class="form-group mb-3">
                <label class="font-weight-bold">Direccion <span class="text-danger">*</span></label>
                <input type="text" name="Direccion" class="form-control" placeholder="Tu Direccion" required />
              </div>
              <div class="form-group mb-5">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" required />
                  <label class="form-check-label text-muted">Acepto los terminos y condiciones.</label>
                </div>
              </div>
              ...
              <div class="item_container">
                <img src="Assets/hamburguesa-queso-clasico-papas-fritas-bebida-gaseosa-menu-parrilla-barbacoa-fondo-gris_113876-3431.jpg" alt="hmaburguesa" />
                <div class="col-xl-5 col-lg-12">
                  <h3>Combo Hamburguesa Clásica</h3>
                  <p class="text-muted">Incluye Papas y Gaseosa</p>
                  <p class="font-weight-bold">13.000$ COP <span class="text-danger">*</span></p>
                  <input type="number" name="UnidHamburguesa" class="form-control unit" min="0" placeholder="Unidades" />
                </div>
              </div>
              <div class="item_container">
                ...
                <div class="col-xl-5 col-lg-12">
                  ...
                  <p class="text-muted">Incluye Papas y Gaseosa</p>
                  <p class="font-weight-bold">18.000$ COP <span class="text-danger">*</span></p>
                  <input type="number" name="UnidHamburguesaDoble" class="form-control unit" min="0" placeholder="Unidades" />
                </div>
              </div>
              <div class="item_container">
                ...
                <div class="col-xl-5 col-lg-12">
                  ...
                  <p class="text-muted">Incluye Papas y Gaseosa</p>
                  <p class="font-weight-bold">10.000$ COP <span class="text-danger">*</span></p>
                  <input type="number" name="UnidPerro" class="form-control unit" min="0" placeholder="Unidades" />
                </div>
              </div>
              <div class="item_container">
                <img src="Assets/vista-superior-deliciosas-porciones-pizza_23-2148925191.jpg" alt="hmaburguesa" />
                <div class="col-xl-5 col-lg-12">
                  <h3>Porcion de Pizza</h3>
                  <p class="text-muted">
                    Viene en sabores Jamón, Hawaiana y Pepperoni.
                  </p>
                  <p class="font-weight-bold">8.000$ COP <span class="text-danger">*</span></p>
                  <input type="number" name="UnidPizza" class="form-control unit" min="0" placeholder="Unidades" /><br />
              ...
              <div class="item_container">
                ...
                <div class="col-xl-5 col-lg-12">
                  ...
                  <p class="font-weight-bold">8.000$ COP <span class="text-danger">*</span></p>
                  <input type="number" name="UnidMalteada" class="form-control unit" min="0" placeholder="Unidades" /><br />
              ...
              <div class="item_container">
                <img src="Assets/depositphotos_9805108-stock-photo-glass-of-cola.jpg" alt="hmaburguesa" />
                <div class="col-xl-5 col-lg-12">
                  <h3>Gaseosa</h3>
                  <p class="text-muted">
                    Viene en sabores Coca-Cola, Manzana y Sprite
                  </p>
                  <p class="font-weight-bold">3.000$ COP <span class="text-danger">*</span></p>
                  <input type="number" name="UnidGaseosa" class="form-control unit" min="0" placeholder="Unidades" /> <br />
            ...
            <center>
              <small class="d-inline-block text-muted mt-5">Todos los derechos reservados | &copy; 2022 por Juan
                Bossa</small>
            </center>
